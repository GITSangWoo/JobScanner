...
| • 프론트엔드 개발<br>• 형상 및 배포 관리<br>• Docker, Airflow<br>• 브랜치 전략 수립 | • 백엔드 개발<br>• 데이터 전처리<br>• 기술 사전 정의<br>•Readme 작성, PPT 제작  | • 프론트 앱 배포<br>• CI/CD 구축<br>• 전처리 메소드 개발<br>• 백엔드 개발 | • 애자일 프로세스 적용(CI/CD)<br>• 크롤링 코드 통합<br>• Docker, Airflow<br>• 인프라 개발 | • 프론트엔드 설계 및 개발<br>• 백엔드 설계<br>• 칸반 미팅 주최<br>• 문서 작업 |
